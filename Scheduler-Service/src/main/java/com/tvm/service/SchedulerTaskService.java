...
public class SchedulerTaskService {
    ...
    //Monthly Payroll Generation (1st day of every month at 6 AM)
    ...
    //Daily Attendance Summary Email (every day 6:30 PM)
    ...
    //Weekly Attendance Summary Email (every Monday 10:00 AM)
    ...
    //Reminders for Pending Leave Approvals (every day 9:00 AM)
    @Scheduled(cron = "0 0 9-18 ? * MON-FRI")
    public void sendLeaveApprovalReminders() {
        //Get admin usernames from Auth Service
        List<String> adminUsernames = authClient.getUsernamesByRole("ADMIN");

        //Get emails of those admins from Employee Service
